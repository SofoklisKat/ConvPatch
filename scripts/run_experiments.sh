#!/usr/bin/env bash
# Run ConvPatch CIFAR-10 ViT-Tiny sweep (all 5 patch-embed variants).
...
#   DEVICE=cuda:0 SEED=1 EPOCHS=100 NUM_WORKERS=8 ./scripts/run_experiments.sh
